 ...
 * @author hudson.sales
 */
public class FrProxy extends javax.swing.JFrame {

    private static final FrProxy INSTANCE = new FrProxy();
    ...
    public static FrProxy getInstance() {
        return INSTANCE;
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Configuração de Proxy"));
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        HsProxy proxy = HsProxy.getInstance();
        proxy.setPath(tfUrl.getText());
        proxy.setPort(tfPorta.getText());
        proxy.setUser(tfUsuario.getText());
        proxy.setPass(tfSenha.getText());
        this.dispose();
